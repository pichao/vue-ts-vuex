<template>
  <div>
    ...
    <div v-for="o in list" :key="o" class="aaa">这里是about页面</div>
    ...
    <div ref="num">{{ num }}</div>
    <div>{{ num1 }}</div>
    <router-link :to="`${aboutDetail()}`">/about/detail</router-link>
